...
function CategoryForm({initialData, isEditing, submitLabel, id}) {
        ...
        <div className="d-flex">
            ...
            <div className="text-center border m-2">
                ...
                <div>
                <input onChange={(e) => {setCategoryName(e.target.value)}} value={categoryName} className={`form-control mr-sm-2 mt-2 `} placeholder="Name"></input>
                </div>
                <div>
                <input onChange={(e) => {setCategoryDescription(e.target.value)}} value={categoryDescription} className={`form-control mr-sm-2 mt-2 `} placeholder="Description"></input>
                </div>
                <div>
                <input onChange={(e) => {setCategorySlug(e.target.value)}} value={categorySlug} className={`form-control mr-sm-2 mt-2 `} placeholder="Slug"></input>
                </div>
                <div>
